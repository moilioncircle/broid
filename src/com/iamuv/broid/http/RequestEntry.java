...
public class RequestEntry {
	...
	Object value = null;
	try {
	    HttpRequestEntry httpRequest = c.getClass().getAnnotation(HttpRequestEntry.class);
	    if (httpRequest != null) {
		...
		connTimeOut = httpRequest.connectionTimeout() > RequestEntry.MAX_CONNECTION_TIMEOUT ? RequestEntry.MAX_CONNECTION_TIMEOUT
		    : httpRequest.connectionTimeout();
		soTimeOut = httpRequest.socketTimeout() > RequestEntry.MAX_SO_TIMEOUT ? RequestEntry.MAX_SO_TIMEOUT
		    : httpRequest.connectionTimeout();
